...
class Booking extends EA_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('cust_identifiers_model');
    ...
    public function index(): void
    {
        ...
        // Generar un código de referencia único de 8 caracteres
        // $codigoReferencia = $this->generarCodigoReferencia();
        // $resultado = $this->cust_identifiers_model->get($codigoReferencia);

        // $encontrado = false;

        // foreach ($resultado as $row) {
        //     if ($row['identifier'] === $codigoReferencia) {
        //         $encontrado = true;
        //         break;
        //     }
        // }
        // if ($encontrado) {
        //     echo "Identificador repetido";
        // } else {
        //     echo "Identificador:" . " referencia|" . $codigoReferencia . "|basedatos: " . json_encode($resultado);
        // }

        // $consentIdentifier = [
        //     'identifier' => $codigoReferencia,
        //     'appointment_id' => '1',
        // ];

        // $result_insert = $this->cust_identifiers_model->save($consentIdentifier);
    ...
    protected function generarCodigoReferencia()
    {
        $longitud = 8;
    ...
    public function mercadoPago(): void
    {
        ...
        try {
            ...
            $hash_appointment = request('hash_appointment');

            // Getting the access token from .env file (create your own function)

            $mpAccessToken = "TEST-3943746097677114-052211-1bcd86e6788f23fe91569f7d55264857-1705922397";
            ...
            $expiration_date =  strtotime($current_date) + 5 * 60;
            $expiration_date = date('Y-m-d\TH:i:sP', $expiration_date);

            $client = new PreferenceClient();
            $preference = $client->create([
                "back_urls" => array(
                    "success" => base_url('/index.php/booking_confirmation/of/' . $hash_appointment),
                    "failure" => base_url('/index.php/booking_cancellation/of/' . $hash_appointment),
                    "pending" => base_url('/index.php')
                ),
                "items" => array(
                    array(
                        "title" => $service_title,
                ...
                "expires" => true,
                "expiration_date_from" => $current_date,
