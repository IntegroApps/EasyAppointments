...
App.Pages.Booking = (function () {
    ...
    function addEventListeners() {
         ...
         */
        $('.button-next').on('click', async (event) => {
            ...
            if ($target.attr('data-step_index') === '3') {
                ...
                // let respuesta = await App.Http.Booking.registerIdentifier(serviceOptionText, 1, priceServiceCheckOut);

                // console.log({ respuesta })

                // const hrefMP = document.getElementById('a-mercadoPago');
                // hrefMP.href = respuesta.sandbox_init_point;
         ...
         * @param {jQuery.Event} event
         */
        $bookAppointmentSubmit.on('click',async () => {
            ...
            await App.Http.Booking.registerAppointment();
            // console.log("Prueba")
        });
    ...
    function updateServiceDescription(serviceId) {
        ...
        if (Number(service.price) > 0) {
            ...
            priceServiceCheckOut = service.price;
        }
